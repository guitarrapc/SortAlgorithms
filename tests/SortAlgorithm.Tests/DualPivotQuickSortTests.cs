...
public class DualPivotQuickSortTests
{
    [Test]
    ...
    public async Task SortResultOrderTest(IInputSample<int> inputSample)
    {
        ...
        DualPivotQuickSort.Sort(array.AsSpan(), stats);
    ...
    public async Task EdgeCaseEmptyArrayTest()
    {
        ...
        DualPivotQuickSort.Sort(empty.AsSpan(), stats);
    }
    ...
    public async Task EdgeCaseSingleElementTest()
    {
        var stats = new StatisticsContext();
        var single = new[] { 42 };
        DualPivotQuickSort.Sort(single.AsSpan(), stats);
    ...
    public async Task EdgeCaseTwoElementsSortedTest()
    {
        ...
        DualPivotQuickSort.Sort(twoSorted.AsSpan(), stats);
    ...
    public async Task EdgeCaseTwoElementsReversedTest()
    {
        ...
        DualPivotQuickSort.Sort(twoReversed.AsSpan(), stats);
    ...
    public async Task EdgeCaseThreeElementsTest()
    {
        var stats = new StatisticsContext();
        var three = new[] { 3, 1, 2 };
        DualPivotQuickSort.Sort(three.AsSpan(), stats);
    ...
    public async Task AllEqualElementsTest()
    {
        ...
        DualPivotQuickSort.Sort(allEqual.AsSpan(), stats);
    ...
    public async Task ManyDuplicatesTest()
    {
        ...
        DualPivotQuickSort.Sort(duplicates.AsSpan(), stats);
    ...
    public async Task LargeArrayTest()
    {
        ...
        DualPivotQuickSort.Sort(large.AsSpan(), stats);
    ...
    public async Task NearlySortedArrayTest()
    {
        ...
        DualPivotQuickSort.Sort(nearlySorted.AsSpan(), stats);
    ...
    public async Task SmallArrayInsertionSortThresholdTest()
    {
        ...
        DualPivotQuickSort.Sort(small.AsSpan(), stats);
    ...
    public async Task StringSortTest()
    {
        ...
        DualPivotQuickSort.Sort(strings.AsSpan(), stats);
