...
public class PDQSortBranchlessTests
{
    [Test]
    ...
    public async Task SortResultOrderTest(IInputSample<int> inputSample)
    {
        ...
        PDQSortBranchless.Sort(array.AsSpan(), stats);
    ...
    public async Task EdgeCaseEmptyArrayTest()
    {
        ...
        PDQSortBranchless.Sort(empty.AsSpan(), stats);
    }
    ...
    public async Task EdgeCaseSingleElementTest()
    {
        var stats = new StatisticsContext();
        var single = new[] { 42 };
        PDQSortBranchless.Sort(single.AsSpan(), stats);
    ...
    public async Task EdgeCaseTwoElementsSortedTest()
    {
        ...
        PDQSortBranchless.Sort(twoSorted.AsSpan(), stats);
    ...
    public async Task EdgeCaseTwoElementsReversedTest()
    {
        ...
        PDQSortBranchless.Sort(twoReversed.AsSpan(), stats);
    ...
    public async Task EdgeCaseThreeElementsTest()
    {
        var stats = new StatisticsContext();
        var three = new[] { 3, 1, 2 };
        PDQSortBranchless.Sort(three.AsSpan(), stats);
    ...
    public async Task RangeSortTest()
    {
        ...
        PDQSortBranchless.Sort(array.AsSpan(), 2, 6, stats);
    ...
    public async Task RangeSortFullArrayTest()
    {
        ...
        PDQSortBranchless.Sort(array.AsSpan(), 0, array.Length, stats);
    ...
    public async Task SortedArrayTest()
    {
        ...
        PDQSortBranchless.Sort(sorted.AsSpan(), stats);
    ...
    public async Task ReverseSortedArrayTest()
    {
        ...
        PDQSortBranchless.Sort(reversed.AsSpan(), stats);
    ...
    public async Task AllEqualElementsTest()
    {
        ...
        PDQSortBranchless.Sort(allEqual.AsSpan(), stats);
    ...
    public async Task ManyDuplicatesTest()
    {
        ...
        PDQSortBranchless.Sort(duplicates.AsSpan(), stats);
    ...
    public async Task LargeArrayTest()
    {
        ...
        PDQSortBranchless.Sort(large.AsSpan(), stats);
    ...
    public async Task NearlySortedArrayTest()
    {
        ...
        PDQSortBranchless.Sort(nearlySorted.AsSpan(), stats);
    ...
    public async Task SmallArrayInsertionSortThresholdTest()
    {
        ...
        PDQSortBranchless.Sort(small.AsSpan(), stats);
    ...
    public async Task StringSortTest()
    {
        ...
        PDQSortBranchless.Sort(strings.AsSpan(), stats);
    ...
    public async Task TheoreticalValuesRandomTest(int n, int seed)
    {
        ...
        PDQSortBranchless.Sort(random.AsSpan(), stats);
