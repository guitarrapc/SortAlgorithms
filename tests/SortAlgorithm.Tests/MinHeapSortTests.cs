...
[InheritsTests]
public class MinHeapSortTests : SortTestsBase
{
    protected override void Sort<T, TContext>(Span<T> span, TContext context)
        => MinHeapSort.Sort(span, context);

    // Sift-down writes elements even for sorted input; the final reversal step performs swaps.
    ...
    public async Task RangeSortTest()
    {
        ...
        MinHeapSort.Sort(array.AsSpan(), 2, 6, stats);
    ...
    public async Task RangeSortFullArrayTest()
    {
        ...
        MinHeapSort.Sort(array.AsSpan(), 0, array.Length, stats);
    ...
    public async Task RangeSortSingleElementTest()
    {
        ...
        MinHeapSort.Sort(array.AsSpan(), 2, 3, stats);
    ...
    public async Task RangeSortBeginningTest()
    {
        ...
        MinHeapSort.Sort(array.AsSpan(), 0, 5, stats);
    ...
    public async Task RangeSortEndTest()
    {
        ...
        MinHeapSort.Sort(array.AsSpan(), 5, 9, stats);
    ...
    public async Task TheoreticalValuesSortedTest(int n)
    {
        ...
        MinHeapSort.Sort(sorted.AsSpan(), stats);

        // MinHeapSort characteristics:
        // Build min-heap phase: O(n) comparisons
        // Extract phase: (n-1) extractions, each requiring O(log n) heapify
        // Reverse phase: n/2 swaps
        //
        // SwapCount: n/2 from reversal (extraction uses Read+Heapify+Write pattern with 0 swaps)
    ...
    public async Task TheoreticalValuesReversedTest(int n)
    {
        ...
        MinHeapSort.Sort(reversed.AsSpan(), stats);
    ...
    public async Task TheoreticalValuesRandomTest(int n, int seed)
    {
        ...
        MinHeapSort.Sort(random.AsSpan(), stats);
