...
public static class IntroSort
{
    ...
    private readonly struct IntroSortAction<T, TComparer> : ContextDispatcher.SortAction<T, TComparer>
    ...
    public static void Sort<T>(Span<T> span, ISortContext context) where T : IComparable<T>
        => ContextDispatcher.DispatchSort(span, new ComparableComparer<T>(), context, new IntroSortAction<T, ComparableComparer<T>>());
    ...
    public static void Sort<T>(Span<T> span, int first, int last, ISortContext context) where T : IComparable<T>
        => ContextDispatcher.DispatchSort(span.Slice(first, last - first), new ComparableComparer<T>(), context, new IntroSortAction<T, ComparableComparer<T>>());
