...
public static class CountingSort
{
    ...
    private readonly struct CountingSortAction<T, TComparer> : ContextDispatcher.SortAction<T, TComparer>
        where TComparer : IComparer<T>
    {
        private readonly Func<T, int> _keySelector;

        public CountingSortAction(Func<T, int> keySelector)
        {
    ...
    public static void Sort<T>(Span<T> span, Func<T, int> keySelector, ISortContext context) where T : IComparable<T>
        => ContextDispatcher.DispatchSort(span, new ComparableComparer<T>(), context, new CountingSortAction<T, ComparableComparer<T>>(keySelector));
    ...
    public static void Sort<T, TComparer>(Span<T> span, Func<T, int> keySelector, TComparer comparer, ISortContext context)
        where TComparer : IComparer<T>
        => ContextDispatcher.DispatchSort(span, comparer, context, new CountingSortAction<T, TComparer>(keySelector));
...
public static class CountingSortInteger
{
    ...
    private readonly struct CountingSortIntegerAction<T, TComparer> : ContextDispatcher.SortAction<T, TComparer>
    ...
    public static void Sort<T>(Span<T> span, ISortContext context) where T : IBinaryInteger<T>, IMinMaxValue<T>
        => ContextDispatcher.DispatchSort(span, new ComparableComparer<T>(), context, new CountingSortIntegerAction<T, ComparableComparer<T>>());
    ...
    public static void Sort<T, TComparer>(Span<T> span, TComparer comparer, ISortContext context)
        where T : IBinaryInteger<T>, IMinMaxValue<T>
        where TComparer : IComparer<T>
        => ContextDispatcher.DispatchSort(span, comparer, context, new CountingSortIntegerAction<T, TComparer>());
