...
public static class BottomupMergeSort
{
    ...
    private readonly struct BottomupMergeSortAction<T, TComparer> : ContextDispatcher.SortAction<T, TComparer>
    ...
    public static void Sort<T>(Span<T> span)
        => Sort<T, IComparer<T>, NullContext>(span, Comparer<T>.Default, NullContext.Default);
    ...
    public static void Sort<T>(Span<T> span, ISortContext context)
        => ContextDispatcher.DispatchSort(span, Comparer<T>.Default, context, new BottomupMergeSortAction<T, IComparer<T>>());
    ...
    public static void Sort<T, TComparer>(Span<T> span, TComparer comparer, ISortContext context)
        where TComparer : IComparer<T>
        => ContextDispatcher.DispatchSort(span, comparer, context, new BottomupMergeSortAction<T, TComparer>());
