...
public static class ShiftSort
{
    ...
    private readonly struct ShiftSortAction<T, TComparer> : ContextDispatcher.SortAction<T, TComparer>
    ...
    public static void Sort<T>(Span<T> span, ISortContext context) where T : IComparable<T>
        => ContextDispatcher.DispatchSort(span, new ComparableComparer<T>(), context, new ShiftSortAction<T, ComparableComparer<T>>());
    ...
    {
        ContextDispatcher.DispatchSort(span, comparer, context, new ShiftSortAction<T, TComparer>());
    }
