...
public static class InsertionSort
{
    ...
    /// <summary>
    /// Sorts the subrange [first..last) where elements in [first..start) are already sorted.
    /// Insertion begins from position <paramref name="start"/>, skipping the presorted prefix.
    /// This is used by hybrid algorithms (e.g., PowerSort, TimSort) to extend short natural runs.
    /// </summary>
    /// <typeparam name="T">The type of elements in the span.</typeparam>
    /// <typeparam name="TComparer">The type of comparer to use for element comparisons.</typeparam>
    /// <typeparam name="TContext">The type of context for tracking operations.</typeparam>
